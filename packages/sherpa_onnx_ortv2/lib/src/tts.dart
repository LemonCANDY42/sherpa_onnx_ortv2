...
import './auto_provider_policy.dart';
...
class OfflineTtsGenerationConfig {
  ...
  Pointer<SherpaOnnxGenerationConfig> toNative() {
    ...
    p.ref.referenceText =
        referenceText.isEmpty ? nullptr : referenceText.toNativeUtf8();
...
class OfflineTtsModelConfig {
  ...
  factory OfflineTtsModelConfig.fromJson(Map<String, dynamic> json) {
    return OfflineTtsModelConfig(
      ...
      provider: json['provider'] as String? ?? 'auto',
    );
  }
...
class OfflineTts {
  ...
  factory OfflineTts(OfflineTtsConfig config) {
    ...
    c.ref.model.pocket.textConditioner =
        config.model.pocket.textConditioner.toNativeUtf8();
    c.ref.model.pocket.vocabJson = config.model.pocket.vocabJson.toNativeUtf8();
    c.ref.model.pocket.tokenScoresJson =
        config.model.pocket.tokenScoresJson.toNativeUtf8();
    c.ref.model.pocket.voiceEmbeddingCacheCapacity =
        config.model.pocket.voiceEmbeddingCacheCapacity;

    c.ref.model.numThreads = config.model.numThreads;
    c.ref.model.debug = config.model.debug ? 1 : 0;
    c.ref.model.provider =
        resolveProvider(config.model.provider, component: 'tts')
            .resolvedProvider
            .toNativeUtf8();
  ...
  GeneratedAudio generateWithCallback({
    ...
    final Pointer<Utf8> textPtr = text.toNativeUtf8();
    final p = SherpaOnnxBindings.offlineTtsGenerateWithCallback?.call(
          ptr,
          textPtr,
          sid,
          speed,
  ...
  GeneratedAudio generateWithConfig({
    ...
    if (onProgress != null) {
      wrapper = NativeCallable<
          SherpaOnnxGeneratedAudioProgressCallbackWithArgNative>.isolateLocal((
        Pointer<Float> samples,
        int n,
        double p,
        Pointer<Void> arg,
    ...
    final p = SherpaOnnxBindings.offlineTtsGenerateWithConfig?.call(
          ptr,
          textPtr,
          cfgPtr,
