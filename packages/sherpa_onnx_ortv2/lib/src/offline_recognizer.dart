...
class OfflineRecognizer {
  ...
  static Pointer<SherpaOnnxOfflineRecognizerConfig> convertConfig(
    ...
    c.ref.model.funasrNano.language =
        config.model.funasrNano.language.toNativeUtf8();
    c.ref.model.funasrNano.itn = config.model.funasrNano.itn;
    c.ref.model.funasrNano.hotwords =
        config.model.funasrNano.hotwords.toNativeUtf8();
    c.ref.model.fireRedAsrCtc.model =
        config.model.fireRedAsrCtc.model.toNativeUtf8();
    ...
    c.ref.model.provider =
        resolveProvider(config.model.provider, component: 'offline_recognizer')
            .resolvedProvider
            .toNativeUtf8();
