...
class OfflineSpeakerDiarization {
  ...
  factory OfflineSpeakerDiarization(OfflineSpeakerDiarizationConfig config) {
    ...
    c.ref.segmentation.provider = resolveProvider(config.segmentation.provider,
            component: 'offline_speaker_diarization_segmentation')
        .resolvedProvider
        .toNativeUtf8();
    ...
    c.ref.embedding.provider = resolveProvider(config.embedding.provider,
            component: 'offline_speaker_diarization_embedding')
        .resolvedProvider
        .toNativeUtf8();
